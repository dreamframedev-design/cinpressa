...
export function PlaceholderNote({ children }: { children: ReactNode }) {
  return (
    <p
      role="note"
      className="inline-flex items-start gap-2 rounded border border-dashed border-[#b45309] bg-[#fffbeb] px-3 py-2 text-[0.7rem] font-semibold uppercase leading-relaxed tracking-[0.1em] text-[#92400e]"
    >
