...
export function AccessGate({ redirectTo = "/home" }: { redirectTo?: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-sm" noValidate>
      <label
        htmlFor="access-code"
        className="flex items-center gap-3 text-[0.84rem] font-semibold uppercase tracking-[0.2em] text-body"
      >
      ...
      <p
        id="access-error"
        role="alert"
        className={`mt-3 text-base text-orange transition-opacity duration-200 ${
